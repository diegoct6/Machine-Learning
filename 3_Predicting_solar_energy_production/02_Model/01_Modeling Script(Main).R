...
sc<-list(CL1=c("BOIS","KENT","GOOD","HOOK"),
         CL2=c("ARNE","BESS","BUTL","WEAT","CHEY","ERIC","CAMA","PUTN","SEIL","HOBA","RETR","CHER","FAIR","LAHO","FREE","MAYR","BEAV","SLAP","BUFF","WOOD"),
         CL3=c("IDAB","DURA"),
         CL4=c("WAUR","RING","MADI","BURN","TIPT","MANG","ALTU","HOLL","MINC","ELRE","STIL","PERK","MARE","SPEN",
               "GUTH","WATO","WASH","PAUL","SULP","CENT","BYAR","ADAX","TISH","BOWL","HINT","FTCB",
                                  "NINN","CHIC","KETC","APAC","ACME","MEDI"),
                            CL5=c("SHAW","CHAN","TAHL","SALL","COOK","WEST","STIG","NOWA","COPA",
                                  "VINI","MIAM","PRYO","JAYX","WILB","TALI","CLAY","STUA","MCAL","MTHE",
                                  "HUGO","CLOU","WIST","LANE","WYNO","SKIA","OKMU","EUFA","OKEM","OILT","BRIS",
                                  "HASK","BIXB","PAWN","NEWK","BURB","REDR","MEDF","FORA","BREC","BLAC"))
